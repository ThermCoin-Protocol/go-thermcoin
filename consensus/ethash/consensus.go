...
var (
	FrontierBlockReward           = big.NewInt(1) // Block reward in wei for successfully mining a block
	ByzantiumBlockReward          = big.NewInt(1) // Block reward in wei for successfully mining a block upward from Byzantium
	ConstantinopleBlockReward     = big.NewInt(1) // Block reward in wei for successfully mining a block upward from Constantinople
